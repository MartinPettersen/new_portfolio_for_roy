...
const DownloadButton = ({label, cv}: Props) => {
  ...
  return (
    <button onClick={() => downloadCV()} className="group font-space-mono py-2 px-4 text-2xl hover:cursor-pointer bg-[#F3E9D6] hover:bg-[#9E9178] hover:font-bold hover:text-white inner-shadow-button inline-flex items-center justify-center gap-2">{label}
