...
const ProjectButtonRight = ({ action }: Props) => {
  return <div className="group inline-block">
    <svg className={" svg-shadow custom-mouse-pointer transition-colors scale-50 group-hover:scale-60"} onClick={() => action()} width="72" height="81" viewBox="0 0 72 81" fill="none" xmlns="http://www.w3.org/2000/svg">
