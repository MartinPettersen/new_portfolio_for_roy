...
const ProgressBar = ({stageCompleted}: Props) => {
  return (
    <div className='w-full flex flex-row h-2'>
      ...
      : null}
      {stageCompleted === 2 ? 
        <svg width="342" height="21" viewBox="0 0 342 21" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      : null}
      {stageCompleted === 3 ? 
        <svg width="643" height="20" viewBox="0 0 643 20" fill="none" xmlns="http://www.w3.org/2000/svg">
